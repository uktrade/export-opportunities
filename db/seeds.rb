...
Country.where(slug: 'afghanistan').first.try(:update, iso_code: 'AF')
Country.where(slug: 'albania').first.try(:update, iso_code: 'AL')
Country.where(slug: 'algeria').first.try(:update, iso_code: 'DZ')
Country.where(slug: 'andorra').first.try(:update, iso_code: 'AD')
Country.where(slug: 'angola').first.try(:update, iso_code: 'AO')
Country.where(slug: 'antigua-and-barbuda').first.try(:update, iso_code: 'AG')
Country.where(slug: 'argentina').first.try(:update, iso_code: 'AR')
Country.where(slug: 'armenia').first.try(:update, iso_code: 'AM')
Country.where(slug: 'australia').first.try(:update, iso_code: 'AU')
Country.where(slug: 'austria').first.try(:update, iso_code: 'AT')
Country.where(slug: 'azerbaijan').first.try(:update, iso_code: 'AZ')
Country.where(slug: 'bahrain').first.try(:update, iso_code: 'BH')
Country.where(slug: 'bangladesh').first.try(:update, iso_code: 'BD')
Country.where(slug: 'barbados').first.try(:update, iso_code: 'BB')
Country.where(slug: 'belarus').first.try(:update, iso_code: 'BY')
Country.where(slug: 'belgium').first.try(:update, iso_code: 'BE')
Country.where(slug: 'belize').first.try(:update, iso_code: 'BZ')
Country.where(slug: 'benin').first.try(:update, iso_code: 'BJ')
Country.where(slug: 'bhutan').first.try(:update, iso_code: 'BT')
Country.where(slug: 'bolivia').first.try(:update, iso_code: 'BO')
Country.where(slug: 'bosnia-and-herzegovina').first.try(:update, iso_code: 'BA')
Country.where(slug: 'botswana').first.try(:update, iso_code: 'BW')
Country.where(slug: 'brazil').first.try(:update, iso_code: 'BR')
Country.where(slug: 'british-virgin-islands').first.try(:update, iso_code: 'VG')
Country.where(slug: 'brunei').first.try(:update, iso_code: 'BN')
Country.where(slug: 'bulgaria').first.try(:update, iso_code: 'BG')
Country.where(slug: 'burkina-faso').first.try(:update, iso_code: 'BF')
Country.where(slug: 'burundi').first.try(:update, iso_code: 'BI')
Country.where(slug: 'cambodia').first.try(:update, iso_code: 'KH')
Country.where(slug: 'cameroon').first.try(:update, iso_code: 'CM')
Country.where(slug: 'canada').first.try(:update, iso_code: 'CA')
Country.where(slug: 'cape-verde').first.try(:update, iso_code: 'CV')
Country.where(slug: 'central-african-republic').first.try(:update, iso_code: 'CF')
Country.where(slug: 'chad').first.try(:update, iso_code: 'TD')
Country.where(slug: 'chile').first.try(:update, iso_code: 'CL')
Country.where(slug: 'china').first.try(:update, iso_code: 'CN')
Country.where(slug: 'colombia').first.try(:update, iso_code: 'CO')
Country.where(slug: 'comoros').first.try(:update, iso_code: 'KM')
Country.where(slug: 'congo').first.try(:update, iso_code: 'CG')
Country.where(slug: 'congo-democratic-republic').first.try(:update, iso_code: 'CD')
Country.where(slug: 'costa-rica').first.try(:update, iso_code: 'CR')
Country.where(slug: 'croatia').first.try(:update, iso_code: 'HR')
Country.where(slug: 'cuba').first.try(:update, iso_code: 'CU')
Country.where(slug: 'cyprus').first.try(:update, iso_code: 'CY')
Country.where(slug: 'czechia').first.try(:update, iso_code: 'CZ')
Country.where(slug: 'denmark').first.try(:update, iso_code: 'DK')
Country.where(slug: 'dit-hq').first.try(:update, iso_code: 'GB')
Country.where(slug: 'djibouti').first.try(:update, iso_code: 'DJ')
Country.where(slug: 'dominica').first.try(:update, iso_code: 'DM')
Country.where(slug: 'dominican-republic').first.try(:update, iso_code: 'DO')
Country.where(slug: 'dso-hq').first.try(:update, iso_code: 'GB')
Country.where(slug: 'east-timor').first.try(:update, iso_code: 'TL')
Country.where(slug: 'ecuador').first.try(:update, iso_code: 'EC')
Country.where(slug: 'egypt').first.try(:update, iso_code: 'EG')
Country.where(slug: 'el-salvador').first.try(:update, iso_code: 'SV')
Country.where(slug: 'equatorial-guinea').first.try(:update, iso_code: 'GQ')
Country.where(slug: 'eritrea').first.try(:update, iso_code: 'ER')
Country.where(slug: 'estonia').first.try(:update, iso_code: 'EE')
Country.where(slug: 'eswatini').first.try(:update, iso_code: 'SZ')
Country.where(slug: 'ethiopia').first.try(:update, iso_code: 'ET')
Country.where(slug: 'fiji').first.try(:update, iso_code: 'FJ')
Country.where(slug: 'finland').first.try(:update, iso_code: 'FI')
Country.where(slug: 'france').first.try(:update, iso_code: 'FR')
Country.where(slug: 'gabon').first.try(:update, iso_code: 'GA')
Country.where(slug: 'georgia').first.try(:update, iso_code: 'GE')
Country.where(slug: 'germany').first.try(:update, iso_code: 'DE')
Country.where(slug: 'ghana').first.try(:update, iso_code: 'GH')
Country.where(slug: 'greece').first.try(:update, iso_code: 'GR')
Country.where(slug: 'grenada').first.try(:update, iso_code: 'GD')
Country.where(slug: 'guatemala').first.try(:update, iso_code: 'GT')
Country.where(slug: 'guinea').first.try(:update, iso_code: 'GN')
Country.where(slug: 'guinea-bissau').first.try(:update, iso_code: 'GW')
Country.where(slug: 'guyana').first.try(:update, iso_code: 'GY')
Country.where(slug: 'haiti').first.try(:update, iso_code: 'HT')
Country.where(slug: 'honduras').first.try(:update, iso_code: 'HN')
Country.where(slug: 'hong-kong').first.try(:update, iso_code: 'HK')
Country.where(slug: 'hungary').first.try(:update, iso_code: 'HU')
Country.where(slug: 'iceland').first.try(:update, iso_code: 'IS')
Country.where(slug: 'india').first.try(:update, iso_code: 'IN')
Country.where(slug: 'indonesia').first.try(:update, iso_code: 'ID')
Country.where(slug: 'iran').first.try(:update, iso_code: 'IR')
Country.where(slug: 'iraq').first.try(:update, iso_code: 'IQ')
Country.where(slug: 'ireland').first.try(:update, iso_code: 'IE')
Country.where(slug: 'israel').first.try(:update, iso_code: 'IL')
Country.where(slug: 'italy').first.try(:update, iso_code: 'IT')
Country.where(slug: 'ivory-coast').first.try(:update, iso_code: 'CI')
Country.where(slug: 'jamaica').first.try(:update, iso_code: 'JM')
Country.where(slug: 'japan').first.try(:update, iso_code: 'JP')
Country.where(slug: 'jordan').first.try(:update, iso_code: 'JO')
Country.where(slug: 'kazakhstan').first.try(:update, iso_code: 'KZ')
Country.where(slug: 'kenya').first.try(:update, iso_code: 'KE')
Country.where(slug: 'kiribati').first.try(:update, iso_code: 'KI')
Country.where(slug: 'kosovo').first.try(:update, iso_code: 'XK')
Country.where(slug: 'kuwait').first.try(:update, iso_code: 'KW')
Country.where(slug: 'kyrgyzstan').first.try(:update, iso_code: 'KG')
Country.where(slug: 'laos').first.try(:update, iso_code: 'LA')
Country.where(slug: 'latvia').first.try(:update, iso_code: 'LV')
Country.where(slug: 'lebanon').first.try(:update, iso_code: 'LB')
Country.where(slug: 'lesotho').first.try(:update, iso_code: 'LS')
Country.where(slug: 'liberia').first.try(:update, iso_code: 'LR')
Country.where(slug: 'libya').first.try(:update, iso_code: 'LY')
Country.where(slug: 'liechtenstein').first.try(:update, iso_code: 'LI')
Country.where(slug: 'lithuania').first.try(:update, iso_code: 'LT')
Country.where(slug: 'luxembourg').first.try(:update, iso_code: 'LU')
Country.where(slug: 'macao').first.try(:update, iso_code: 'MO')
Country.where(slug: 'madagascar').first.try(:update, iso_code: 'MG')
Country.where(slug: 'malawi').first.try(:update, iso_code: 'MW')
Country.where(slug: 'malaysia').first.try(:update, iso_code: 'MY')
Country.where(slug: 'maldives').first.try(:update, iso_code: 'MV')
Country.where(slug: 'mali').first.try(:update, iso_code: 'ML')
Country.where(slug: 'malta').first.try(:update, iso_code: 'MT')
Country.where(slug: 'marshall-islands').first.try(:update, iso_code: 'MH')
Country.where(slug: 'mauritania').first.try(:update, iso_code: 'MR')
Country.where(slug: 'mauritius').first.try(:update, iso_code: 'MU')
Country.where(slug: 'mexico').first.try(:update, iso_code: 'MX')
Country.where(slug: 'micronesia').first.try(:update, iso_code: 'FM')
Country.where(slug: 'moldova').first.try(:update, iso_code: 'MD')
Country.where(slug: 'monaco').first.try(:update, iso_code: 'MC')
Country.where(slug: 'mongolia').first.try(:update, iso_code: 'MN')
Country.where(slug: 'montenegro').first.try(:update, iso_code: 'ME')
Country.where(slug: 'morocco').first.try(:update, iso_code: 'MA')
Country.where(slug: 'mozambique').first.try(:update, iso_code: 'MZ')
Country.where(slug: 'myanmar').first.try(:update, iso_code: 'MM')
Country.where(slug: 'namibia').first.try(:update, iso_code: 'NA')
Country.where(slug: 'nauru').first.try(:update, iso_code: 'NR')
Country.where(slug: 'nepal').first.try(:update, iso_code: 'NP')
Country.where(slug: 'netherlands').first.try(:update, iso_code: 'NL')
Country.where(slug: 'new-zealand').first.try(:update, iso_code: 'NZ')
Country.where(slug: 'nicaragua').first.try(:update, iso_code: 'NI')
Country.where(slug: 'niger').first.try(:update, iso_code: 'NE')
Country.where(slug: 'nigeria').first.try(:update, iso_code: 'NG')
Country.where(slug: 'north-korea').first.try(:update, iso_code: 'KP')
Country.where(slug: 'north-macedonia').first.try(:update, iso_code: 'MK')
Country.where(slug: 'norway').first.try(:update, iso_code: 'NO')
Country.where(slug: 'oman').first.try(:update, iso_code: 'OM')
Country.where(slug: 'pakistan').first.try(:update, iso_code: 'PK')
Country.where(slug: 'palau').first.try(:update, iso_code: 'PW')
Country.where(slug: 'palestinian-territories').first.try(:update, iso_code: 'PS')
Country.where(slug: 'panama').first.try(:update, iso_code: 'PA')
Country.where(slug: 'papua-new-guinea').first.try(:update, iso_code: 'PG')
Country.where(slug: 'paraguay').first.try(:update, iso_code: 'PY')
Country.where(slug: 'peru').first.try(:update, iso_code: 'PE')
Country.where(slug: 'poland').first.try(:update, iso_code: 'PL')
Country.where(slug: 'portugal').first.try(:update, iso_code: 'PT')
Country.where(slug: 'qatar').first.try(:update, iso_code: 'QA')
Country.where(slug: 'romania').first.try(:update, iso_code: 'RO')
Country.where(slug: 'russia').first.try(:update, iso_code: 'RU')
Country.where(slug: 'rwanda').first.try(:update, iso_code: 'RW')
Country.where(slug: 'samoa').first.try(:update, iso_code: 'WS')
Country.where(slug: 'san-marino').first.try(:update, iso_code: 'SM')
Country.where(slug: 'sao-tome-and-principe').first.try(:update, iso_code: 'ST')
Country.where(slug: 'saudi-arabia').first.try(:update, iso_code: 'SA')
Country.where(slug: 'senegal').first.try(:update, iso_code: 'SN')
Country.where(slug: 'serbia').first.try(:update, iso_code: 'RS')
Country.where(slug: 'seychelles').first.try(:update, iso_code: 'SC')
Country.where(slug: 'sierra-leone').first.try(:update, iso_code: 'SL')
Country.where(slug: 'singapore').first.try(:update, iso_code: 'SG')
Country.where(slug: 'slovakia').first.try(:update, iso_code: 'SK')
Country.where(slug: 'slovenia').first.try(:update, iso_code: 'SI')
Country.where(slug: 'solomen-islands').first.try(:update, iso_code: 'SB')
Country.where(slug: 'somalia').first.try(:update, iso_code: 'SO')
Country.where(slug: 'south-africa').first.try(:update, iso_code: 'ZA')
Country.where(slug: 'south-korea').first.try(:update, iso_code: 'KR')
Country.where(slug: 'south-sudan').first.try(:update, iso_code: 'SS')
Country.where(slug: 'spain').first.try(:update, iso_code: 'ES')
Country.where(slug: 'sri-lanka').first.try(:update, iso_code: 'LK')
Country.where(slug: 'st-kitts-and-nevis').first.try(:update, iso_code: 'KN')
Country.where(slug: 'st-lucia').first.try(:update, iso_code: 'LC')
Country.where(slug: 'st-vincent').first.try(:update, iso_code: 'VC')
Country.where(slug: 'sudan').first.try(:update, iso_code: 'SD')
Country.where(slug: 'suriname').first.try(:update, iso_code: 'SR')
Country.where(slug: 'sweden').first.try(:update, iso_code: 'SE')
Country.where(slug: 'switzerland').first.try(:update, iso_code: 'CH')
Country.where(slug: 'syria').first.try(:update, iso_code: 'SY')
Country.where(slug: 'taiwan').first.try(:update, iso_code: 'TW')
Country.where(slug: 'tajikistan').first.try(:update, iso_code: 'TJ')
Country.where(slug: 'tanzania').first.try(:update, iso_code: 'TZ')
Country.where(slug: 'thailand').first.try(:update, iso_code: 'TH')
Country.where(slug: 'the-bahamas').first.try(:update, iso_code: 'BS')
Country.where(slug: 'the-gambia').first.try(:update, iso_code: 'GM')
Country.where(slug: 'the-philippines').first.try(:update, iso_code: 'PH')
Country.where(slug: 'the-united-arab-emirates').first.try(:update, iso_code: 'AE')
Country.where(slug: 'the-usa').first.try(:update, iso_code: 'US')
Country.where(slug: 'togo').first.try(:update, iso_code: 'TG')
Country.where(slug: 'tonga').first.try(:update, iso_code: 'TO')
Country.where(slug: 'trinidad-and-tobago').first.try(:update, iso_code: 'TT')
Country.where(slug: 'tunisia').first.try(:update, iso_code: 'TN')
Country.where(slug: 'turkey').first.try(:update, iso_code: 'TR')
Country.where(slug: 'turkmenistan').first.try(:update, iso_code: 'TM')
Country.where(slug: 'tuvalu').first.try(:update, iso_code: 'TV')
Country.where(slug: 'uganda').first.try(:update, iso_code: 'UG')
Country.where(slug: 'ukraine').first.try(:update, iso_code: 'UA')
Country.where(slug: 'uruguay').first.try(:update, iso_code: 'UY')
Country.where(slug: 'uzbekistan').first.try(:update, iso_code: 'UZ')
Country.where(slug: 'vanuatu').first.try(:update, iso_code: 'VU')
Country.where(slug: 'vatican-city').first.try(:update, iso_code: 'VA')
Country.where(slug: 'venezuela').first.try(:update, iso_code: 'VE')
Country.where(slug: 'vietnam').first.try(:update, iso_code: 'VN')
Country.where(slug: 'yemen').first.try(:update, iso_code: 'YE')
Country.where(slug: 'zambia').first.try(:update, iso_code: 'ZM')
Country.where(slug: 'zimbabwe').first.try(:update, iso_code: 'ZW')

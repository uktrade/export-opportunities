class OpportunitySort
  ...
  VALID_SORT_COLUMNS = %w[title status service_provider_name enquiries_count created_at original_language source tender_source first_published_at response_due_on ragg].freeze

...
class Opportunity < ApplicationRecord
  ...
  #         
  #         dit_boost_search: Boolean, makes the search
  #                           prioritise DIT-sourced results
  # Returns: an ElasticSearch search results object
  #
  def self.public_search(search_term: nil, filters: NullFilter.new,
                         limit: 0, sort:, dit_boost_search: false)
  ...
  # Returns Opportunities search results given a set of parameters
  # Inputs:  --- Optional ---
  #          sector:      String, slug of sector
  #          search_term: String, term to search
  #          sources:     Hash, generated by a SearchFilter
  #          sort:        Sort object
  # Returns: an ElasticSearch search results object
  #

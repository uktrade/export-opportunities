...
class DocumentStorage
  def initialize
    ...
    @s3 = Aws::S3::Resource.new(region: Figaro.env.aws_region!, credentials: Aws::Credentials.new(Figaro.env.aws_access_key_id!, Figaro.env.aws_secret_access_key!))
    @s3_client = Aws::S3::Client.new(region: Figaro.env.aws_region!, credentials: Aws::Credentials.new(Figaro.env.aws_access_key_id!, Figaro.env.aws_secret_access_key!))

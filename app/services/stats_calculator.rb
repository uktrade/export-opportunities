class StatsCalculator
  ...
  def call(criteria)
    ...
    when 'ServiceProvider'
      if criteria.all_service_providers?
        opportunities_submitted, opportunities_published, enquiries = global_results(date_range)
      else
    ...
    when 'Country'
      ...
      opportunities_submitted, opportunities_published, enquiries = results_with_filters(service_providers, date_range)
    when 'Region'
      service_providers = []
  ...
  def global_results(date_range)
    ...
    [opportunities_submitted, opportunities_published, enquiries]
  end

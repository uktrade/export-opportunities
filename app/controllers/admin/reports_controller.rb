...
module Admin
  class ReportsController < BaseController
    ...
    def format_opportunity_totals(row)
      ...
      line = [
          row.title.to_s,
          row.opportunities_published.to_a.join(','),
          ytd_actual,
          row.opportunities_published_target,
          report_format_progress(ytd_actual, row.opportunities_published_target),
      ]
    ...
    def format_response_totals(row)
      ...
      line = [
          row.title.to_s,
          row.responses.to_a.join(','),
          ytd_actual,
          row.responses_target,
          report_format_progress(ytd_actual, row.responses_target),
      ]

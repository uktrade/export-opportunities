...
RSpec.describe Opportunity do
  ...
  describe '#as_indexed_json' do
    it 'returns only the keys we want' do
      ...
      permitted_keys = Set.new %w[title teaser description countries sectors types values created_at updated_at status response_due_on first_published_at source opportunity_cpvs]

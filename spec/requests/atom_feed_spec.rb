...
RSpec.describe 'Viewing the ATOM feed for opportunities', :elasticsearch, :commit, type: :request do
  ...
  it 'returns the opportunities ordered by updated_at, with newest first' do
    ...
    newest_opportunity = create(:opportunity, :published, updated_at: 1.day.ago, title: 'newest')
    new_opportunity = create(:opportunity, :published, updated_at: 2.days.ago, title: 'new')
    old_opportunity = create(:opportunity, :published, updated_at: 3.days.ago, title: 'old')

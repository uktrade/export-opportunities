...
describe 'api users can fetch expopps opportunities and email alerts' do
  ...
  it 'submit a valid request' do
    ...
    get "/api/profile_dashboard?sso_user_id=#{user}&shared_secret=#{@secret}"
  ...
  it 'submit invalid shared secret' do
    ...
    get "/api/profile_dashboard?sso_user_id=#{user}&shared_secret=not_so_secret"
  ...
  it 'lacks shared_secret parameter from request' do
    ...
    get "/api/profile_dashboard?sso_user_id=#{user}"
  ...
  it 'lacks sso_user_id parameter from request' do
    get "/api/profile_dashboard?shared_secret=#{@secret}"

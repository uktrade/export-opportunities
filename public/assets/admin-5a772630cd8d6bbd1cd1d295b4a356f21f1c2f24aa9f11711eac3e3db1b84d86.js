...
ukti.config = {
	//"tinyMcePath" : "/images/tinymcefull/tinymce.js",
	"tinyMcePath" : "/js/tinymcefull/tinymce.js",
	"ckeditorPath" : "/js/ckeditor/ckeditor.js",
	"textEditorScriptPath" : "/assets/ckeditor/ckeditor-dc23e1a3aa5a90cd82774640a718967dcbb3af37c1dfe03a09d925692bb92cae.js"
};
...
$('document').ready(function() {
  ...
  if($opportunityTitle.length) {
    ukti.CharacterCounter.init($opportunityTitle, 80);
  }
  var $opportunityTeaser = $('#opportunity_teaser');
  if($opportunityTeaser.length) {
    ukti.CharacterCounter.init($opportunityTeaser, 140);
  }
	...
	if (oppEditForm || oppNewEnquiryResponsesControllerForm) {
		datePickerController.createDatePicker({

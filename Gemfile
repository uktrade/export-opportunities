...
gem 'normalize-scss'
gem 'sass-rails'
gem 'export_components', '~> 2.0', git: 'https://github.com/uktrade/export_components.git'
...
group :development do
  gem 'web-console'
  gem 'rubocop', '~> 0.66.0', require: false#, '~> 0.63.1', require: false
  gem 'listen'
end
